...
Example: <https://testnet-explorer.kymaticscan.online/token/0x68D2E27940CA48109Fa3DaD0D2C8B27E64a0c6cf>
...
Get API key: https://kymaticscan.online/myapikey
...
- Verify
```
truffle run verify KTC20Token@{contract-address} --network testnet
```
You should see the following output:

```
Verifying KTC20Token@0x68D2E27940CA48109Fa3DaD0D2C8B27E64a0c6cf
Pass - Verified: https://testnet-explorer.kymaticscan.online/address/0x68D2E27940CA48109Fa3DaD0D2C8B27E64a0c6cf#contracts
