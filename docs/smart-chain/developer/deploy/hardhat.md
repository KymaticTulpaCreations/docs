...
You can write your own smart contract or download the [KTC20 token smart contract template](../KTC20Token.template).

### Config Hardhat for KYMATIC
...
module.exports = {
  ...
  networks: {
    ...
    testnet: {
      url: "https://testnet-rpc.kymaticscan.online",
      chainId: 24076,
      gasPrice: 20000000000,
      accounts: {mnemonic: mnemonic}
    },
    mainnet: {
      url: "https://nc-dataseed.kymaticscan.online/",
      chainId: 15430,
      gasPrice: 20000000000,
      accounts: {mnemonic: mnemonic}
    }
