...
Deploys a KTC20 smart contract with a message, and renders it in the front-end. You can interact with the smart contract easily!
...
- Create new contract KTC20Token.sol and copy contract code from the bep20 token template [here](../KTC20Token.template)
...
- Step2: Select “KTC20Token” contract
...
Now, We have to deploy our smart contract on Kymatic Chain Network. For that, we have to connect to web3 world, this can be done my many services like Metamask, Brave, Portis etc. We will be using Metamask. Please follow this [tutorial to setup a Metamask Account](../../wallet/metamask.md).
...
* Testnet
        ...
        * ChainID: 24076
        * Symbol: KYMATIC
        * Block Explorer: https://testnet-explorer.kymaticscan.online

* Mainnet
        * [RPC URLs](../rpc.md)
        * ChainID: 15430
        * Symbol: KYMATIC
        * Block Explorer: https://kymaticscan.online


- Go ahead and click save
- Copy your address from Metamask

- Head over to [Faucet](https://faucet.kymaticscan.online) and request test KYMATIC

- Now, let's Deploy the Smart Contract on Kymatic Chain Testnet
...
**Congratulations!** You have successfully deployed a KTC20 Contract. Now you can interact with the Smart Contract. Check the deployment status here: <https://testnet-explorer.kymaticscan.online/>
