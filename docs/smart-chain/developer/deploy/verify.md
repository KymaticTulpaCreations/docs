# How to Verify Your Contract on kymaticscan.online

## Step 1: Deploy your contract on Kymatic Chain

## Step 2: Go to [NCExplorer](https://kymaticscan.online/) or [Testnet Explorer](https://testnet-explorer.kymaticscan.online/)
...
!!! info
	...
	The default KTC20 contract template does not have a constructor method
