...
You can write your own smart contract or download the KTC20 token smart contract template.
...
module.exports = {
  networks: {
    development: {
      ...
      port: 8545,            // Standard KYMATIC port (default: none)
      network_id: "*",       // Any network (default: none)
    },
    testnet: {
      provider: () => new HDWalletProvider(mnemonic, `https://testnet-rpc.kymaticscan.online`),
      network_id: 24076,
      confirmations: 10,
      timeoutBlocks: 200,
      skipDryRun: true
    ...
    bsc: {
      provider: () => new HDWalletProvider(mnemonic, `https://mainnet-rpc.kymaticscan.online`),
      network_id: 15430,
      confirmations: 10,
      timeoutBlocks: 200,
      skipDryRun: true
...
Contract will be deployed on Kymatic Chain Chapel Testnet, it look like this:
...
**Congratulations!** You have successfully deployed KTC20 Smart Contract. Now you can interact with the Smart Contract.

You can check the deployment status here: <https://kymaticscan.online/> or <https://testnet-explorer.kymaticscan.online/>
