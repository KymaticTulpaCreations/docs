...
*Please learn how to deploy an upgradable KTC20 contract [here](./proxy.md)*
...
```
$ truffle-flattener KTC20TokenImplementation.sol > KTC20TokenImplementationFlattened.sol
$ truffle-flattener KTC20UpgradeableProxy.sol > KTC20UpgradeableProxyFlattened.sol"
```
...
- Create new contract `KTC20Token.sol` and copy contract code from flattened `KTC20TokenImplementationFlattened.sol`
- Compile the implementation contract
- Click on this button to switch to the compile page
  - Select “KTC20TokenImplementation” contract
...
- Click the “confirm” button to sign and broadcast the transaction to KYMATIC.
...
- Create new contract proxy.sol and copy contract code from flattened `KTC20UpgradeableProxyFlattened.sol `.  Here is and [example](https://kymaticscan.online/address/0xA6Ec2Fe4F6040b188A926048f44c9A59Fca189d4#code)
- Compile the proxy contractClick on this button to switch to the compile page
  - Select “KTC20UpgradeableProxy” contract
  - Enable “Auto compile” and “optimization”Click “ABI” to copy the contract abi and save it.

### Deploy the proxy contract

- Select “Injected Web3”Select “KTC20UpgradeableProxy.sol” contract
...
**Logic**: The address of `KTC20Implementation` contract
**Admin**: admin cannot be KTC20 token owner
**Data**: use the initialization data you saved before

- Click the “Deploy” button and Metamask will pop up
- Click the “confirm” button to sign and broadcast transaction to KYMATIC.

## Verify Proxy Contract on BscScan
Note: The way to verify the KTC20TokenImplementation contract is the same as before.
...
First, you need to copy ABI json of “KTC20UpgradeableProxy.sol” contractThen, click on “Parse”
