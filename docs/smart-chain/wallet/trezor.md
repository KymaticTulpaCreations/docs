...
KYMATIC and coins on Kymatic Chain are supported by the Trezor hardware wallet. The following describes how to use Trezor to connect to KYMATIC.
...
Kymatic Chain is compatible with MetaMask. Users can use MetaMask as a bridge between Trezor and Kymatic Chain to make transactions to the Kymatic Chain testnet.
