# Use MetaMask For Kymatic Chain
...
## Create an account in MetaMask for Kymatic Chain
...
## Connect Your MetaMask With Kymatic Chain
...
4. Go to faucet page: https://faucet.kymaticscan.online, then paste your address in the box and click on “Give me KYMATIC”
...
## Transfer KYMATIC to other Kymatic Chain address
...
2. Connect your Kymatic Chain Account to Remix</br>
...
To solve this issue, click on "'Settings" and enter Chain ID of Kymatic Chain network again. If **15430** doesn’t work, try **0x3C46**. 
