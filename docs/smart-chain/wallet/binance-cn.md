...
* 打开以下页面 <https://faucet.kymaticscan.online/>
...
* 打开钱包后，切换到Kymatic Chain Testnet
...
* 粘贴到输入框并点击 “Give me KYMATIC”
* 点击 “+” and 添加“KYMATIC” 代币
...
* 打开钱包后，切换到Kymatic Chain Testnet。复制地址，以 `tbnb1`开头
...
* 切换到Kymatic Chain Testnet，点击 “Send”
...
* 切换到Kymatic Chain Testnet，确认转账完成
...
* 打开钱包后，切换到Kymatic Chain Testnet。复制地址，以 `0x`开头
...
## 在测试网上完将BEP2代币转换为KTC20格式

* 根据以上指令完成安装
* 根据以上指令完成账户的创建或恢复
* 打开钱包后，切换到Kymatic  Chain Testnet。点击“+” 添加你的BEP2代币
...
**确认KYMATIC余额够支付跨链转账费用**

* 切换到Kymatic Chain Testnet。复制地址，以 `tbnb1`开头
...
* 切换到Kymatic Chain Testnet，确认收到KTC20代币
...
## 在测试网上完将KTC20代币转换为BEP2格式

* 根据以上指令完成安装
* 根据以上指令完成账户的创建或恢复
* 打开钱包后，切换到Kymatic Chain Testnet。点击“+” 添加你的KTC20代币
...
* 切换到Kymatic Chain Testnet，确认收到BEP2代币
