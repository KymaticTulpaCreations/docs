# How to use ezDeFi for Kymatic Chain
...
## Getting the Kymatic Chain 
### On mobile app, go to "Setting" => "Advanced Setting" => "Custom RPC Network" to see default Kymatic Chain . On browser extension, go to "Setting" => "Network" to see default Kymatic Chain 
...
## Add KYMATIC token in your wallet

### On mobile app, tap on the "Add more", search for "Smart Chain", tap on the "+" button and create new address of KYMATIC token
###  On browser extension, click on "More Assets", search for "Smart Chain", select KYMATIC token
...
### Back to mains creen to see KYMATIC token already added on mobile app (or browser extension)
...
## Add a address of KYMATIC token 
...
### ezDeFi Wallet is fully compatible with Kymatic Chain DApps.
### On mobile app
