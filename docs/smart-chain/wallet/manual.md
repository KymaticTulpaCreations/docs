# How to manually install the Kymatic Chain Extension Wallet

## Download the zip file

Visit https://kymaticscan.online/en/
...
Click **Chrome** and you will download the file `Kymatic ChainBrowserExtension-1.114.0.zip`
