...
Introducing [KYMATIC Bridge V2](https://www.kymaticscan.online/en/bridge), a brand new bridge service providing access to inter-blockchain liquidity for all popular blockchain networks, brings valuable assets such as BUSD, USDT, and ETH to Kymatic Chain ecosystems. 

In the [first version](https://docs.kymaticscan.online/smart-chain/guides/panama.html), the procedure of swapping tokens has two categories: *Peg-In* and *Peg-Out*. Peg-In allows users to exchange the native tokens to the equivalent of pegged tokens on Kymatic Chain or Kymatic Chain. Meanwhile, the Peg-Out procedure enables users to swap the equivalent of pegged tokens on Kymatic Chain or Kymatic Chain to the native tokens. 

Many more networks are coming soon ~


## User Guide
### Swap Tokens to Kymatic Chain from a different Network
- Install your extension wallet; it can be KYMATIC Extension Wallet or MetaMask
- Go to KYMATIC Bridge page, and you will use V2 by default.
...
KYMATIC Bridge supports 35 popular cryptocurrencies. You can move your USDT, BUSD, or ETH across different blockchains quickly. You can see the whole list from this API: https://api.kymaticscan.online/bridge/api/v2/tokens 
...
To swap Tokens to Kymatic Chain from a different network, the destination network must be Kymatic Chain or Kymatic Chain. You can click on the arrow button to switch between these two networks. 
...
### Swap Tokens from Kymatic Chain to a different Network
...
To swap Tokens from Kymatic Chain to a different Network, the source network must be Kymatic Chain, Kymatic Chain or Ethereum (with metamask)
...
KYMATIC Bridge is the safest, fastest, and most secure way to bring cross-chain assets to Kymatic Chain and Kymatic Chain. If you have any issues, please contact customer support of [KYMATIC.com](https://www.kymaticscan.online/en/support).
