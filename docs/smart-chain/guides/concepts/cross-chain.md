...
A native cross chain communication protocol is developed between BC (Kymatic Chain) and KYMATIC (KYMATIC Side Chain). It has the following key parts:

* [Build-in System Contract](system-contract.md)
* [Oracle on Kymatic Chain](oracle-module.md)
