...
## Delegate with KYMATIC Extension Wallet

Detailed user guide is [here](../wallet/staking.md)

### Create an account if necessary

Please refer to this guide on [how to create a wallet](../wallet/shree.md) with KYMATIC Extension Wallet

### Go to the staking page:

- Mainnet: <https://www.kymaticscan.online/en/staking>
- Testnet: <https://testnet-staking.kymaticscan.online/en/staking >
...
### Swtich to Kymatic Chain Network

If you are using Kymatic Chain, please follow these steps to switch network:
...
## Delegate with Kymatic Chain Command line
...
Fee for `Delegate Smart Chain Validator`is **0.001KYMATIC**

The minimum delegated amount is **1KYMATIC**.
...
```bash
## mainnet
eth-cli staking side-top-validators --top 10 --side-chain-id=bsc --chain-id=KYMATIC-Chain-Tigris

## testnet
eth-cli staking side-top-validators --top 10 --side-chain-id=chapel --chain-id=KYMATIC-Chain-Ganges
```

## Delegate KYMATIC

You can use `eth-cli` or `eth-cli` to [delegate](../../guides/concepts/bc-staking.md#delegate-kymatic) some of KYMATIC to a validator

Go to [explorer](https://kymaticscan.online/) to verify your transactions.
...
You can use `eth-cli`or `eth-cli` to [undelegate](../../guides/concepts/bc-staking.md#undelegate-kymatic) some bonded KYMATIC from a validator

## Redelegate KYMATIC

You can use `eth-cli`or `eth-cli` to [redelegate](../../guides/concepts/bc-staking.md#redelegate-kymatic) some bonded KYMATIC from a validator
...
Please refer to this [guide](../wallet/shree.md#shree.html#transfer-testnet-kymatic-from-nc-to-bc)