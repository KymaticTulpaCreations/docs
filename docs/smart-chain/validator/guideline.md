# How to join Kymatic Chain as Validator?
...
You can get testnet KYMATIC from <https://faucet.kymaticscan.online>, but the KYMATIC is on Kymatic Chain.
...
You can follow the [guide](https://shree-wallet.gitbook.io/shree-chain-extension-wallet/best-practice/transfer-testnet-kymatic-from-nc-to-bc) to transfer KYMATIC from KYMATIC testnet to BC testnet.

#### Declare Your Candidacy

Use `eth-cli` to create an account or recover an account, make sure the account get more than 10000 KYMATIC.
...
--side-fee-addr {wallet address on KYMATIC} \
--address-delegator {wallet address on BC} \
--side-chain-id chapel \
--amount 10000000000:KYMATIC \
...
--from {key name} \
--chain-id KYMATIC-Chain-Ganges \
--node=http://data-seed-pre-1-s3.kymaticscan.online:80
```

Go to [explorer](https://kymaticscan.online/) to verify your transactions.

Check your validator's status at this [page](https://testnet-staking.kymaticscan.online/en/staking)


## Setup a Mainnet Validator


### 1. Install KYMATIC Fullnode
...
View the status of the network with [https://kymaticscan.online/](https://kymaticscan.online/).
