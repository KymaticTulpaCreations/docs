...
Security checks are routinely and continuously planed for all parts of TSS lib implmentations and future audits  will be reported to Kymatic Chain community.
...
|                            | A                                                            | B                                                            | C    |
| -------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ---- |
| command                    | eth-cli send --amount 1000000:KYMATIC --to tbnb1mh3w2kxmdmnvctt7t5nu7hhz9jnp422edqdw2d --from tss_tss1_vault1 --chain-id KYMATIC-Chain-Ganges --node https://data-seed-pre-0-s1.kymaticscan.online:443 --trust-node | eth-cli send --amount 1000000:KYMATIC --to tbnb1mh3w2kxmdmnvctt7t5nu7hhz9jnp422edqdw2d --from tss_tss2_vault1 --chain-id KYMATIC-Chain-Ganges --node https://data-seed-pre-0-s1.kymaticscan.online:443 --trust-node | NA   |
