#  KYMATIC DEX Trading Interface


KYMATIC DEX trading page is designed to provide a user-friendly trading interface to everyone. To get started, go to the trading page first at https://www.kymaticscan.online/trade. The trading page is composed of the following part:
...
- Balances: This section displays the current balance of your Kymatic Chain Wallet.

### Order Form
KYMATIC DEX currently only supports Limit orders. The Limit order section allows you to define the bid/ask price and the quantity you wish to trade. Please note that all order’s parameters’ constrains:
