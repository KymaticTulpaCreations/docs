...
1 KYMATIC will be charged on enabling  memo validation of transactions.
...
```
./eth-cli token account_flags set-account-flags --from <your-key-name> --account-flags 0x01  --chain-id KYMATIC-Chain-Tigris --node  https://dataseed5.defibit.io:443 --trust-node
```
...
```
./eth-cli token account_flags set-account-flags --from <your-key-name> --account-flags 0x01 --chain-id KYMATIC-Chain-Ganges --trust-node --node http://data-seed-pre-0-s3.kymaticscan.online:80
```
...
```
./eth-cli account_flags enable-memo-checker --chain-id KYMATIC-Chain-Tigris --node  https://dataseed5.defibit.io:443 --trust-node
```

* Example on testnet:

```
./eth-cli account_flags enable-memo-checker --chain-id KYMATIC-Chain-Ganges --trust-node --node http://data-seed-pre-0-s3.kymaticscan.online:80
```
...
```
./eth-cli account_flag disable-memo-checker --chain-id KYMATIC-Chain-Tigris --node  https://dataseed5.defibit.io:443 --trust-node
```
...
```
./eth-cli account_flag disable-memo-checker --chain-id KYMATIC-Chain-Ganges --trust-node --node http://data-seed-pre-0-s3.kymaticscan.online:80
```
