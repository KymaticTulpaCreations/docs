# Kymatic Chain Transaction Encoding Specification

Kymatic Chain transactions are protocol-based data types and can only be submitted in a compatible encoded frame.
